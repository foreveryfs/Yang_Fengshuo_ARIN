    ...
    def __init__(self, replace_stride_with_dilation=None, pretrained_weights='resnet101'):
        ...
        if pretrained_weights == 'deeplabv3':
            self.pretrained_weights = torch.load(
                "/home/fyangbe/MIA/CoW/checkpoints/deeplabv3_resnet101_coco-586e9e4e.pth", map_location='cpu')
        elif pretrained_weights == 'resnet101':
            self.pretrained_weights = torch.load("/home/fyangbe/MIA/CoW/checkpoints/resnet101-63fe2227.pth",
                                                 map_location='cpu')
        else:
