#!/bin/bash
# test a model to segment abdominal CT
GPUID1=0
export CUDA_VISIBLE_DEVICES=$GPUID1

###### Shared configs ######
DATASET='SABS'   # 'CMR' or 'SABS'
NWORKER=16
RUNS=1
ALL_EV=(0 1 2) # 5-fold cross validation (0, 1, 2, 3, 4)
...
do
  ...
  do
    ...
    RELOAD_MODEL_PATH="/home/fyangbe/MIA/CoW/exps_on_SABS/CoW_train_SABS_cv${EVAL_FOLD}/1/snapshots/20000.pth"
    python3 test_ct.py with \
    mode="test" \
    dataset=$DATASET \
    num_workers=$NWORKER \
    n_steps=$NSTEP \
