...
ex = Experiment("CoW", save_git_info=False)
...
def cfg():
    ...
    supp_idx = 2  # choose which case as the support set for evaluation, (0-4) for 'CHAOST2', (0-7) for 'CMR'
    ...
    max_iters_per_load = 5000  # epoch size, interval for reloading the dataset
